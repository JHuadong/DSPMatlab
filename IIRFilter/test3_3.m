...
figure(2);
subplot(2,2,1);plot(w,20*log10(abs(hh1)),'b');
title('低通切比雪夫一型双线性幅频特性(取对数)');ylabel('幅度 dB');xlabel('w/rad');
set(gca,'XTickMode','manual','XTick',[ 0.5*pi 0.6*pi]);
set(gca,'YTickMode','manual','YTick',[-50 -15 -1 0]);
grid;
...
figure(2);
subplot(2,2,2);plot(w,20*log10(abs(hh2)),'b');
...
figure(2);
subplot(2,2,3);plot(w,20*log10(abs(hh3)),'b');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%不取对数%%%%%%%%%%%%%%%%%%%%%%%%%%%%
figure(3);
subplot(2,2,1);plot(w,(abs(hh1)),'b');
title('低通切比雪夫一型双线性幅频特性');ylabel('幅度 ');xlabel('w/rad');
subplot(2,2,2);plot(w,(abs(hh2)),'b');
title('低通切比雪夫二型双线性幅频特性');ylabel('幅度 ');xlabel('w/rad');
subplot(2,2,3);plot(w,(abs(hh3)),'b');
title('低通椭圆型双线性幅频特性');ylabel('幅度 ');xlabel('w/rad');

%%%%%%%%%%%%%%%%%%%%%%%%%%%%相位特性%%%%%%%%%%%%%%%%%%%%%%%%%%%%
figure(4);
subplot(2,2,1);plot(w,(angle(hh1)),'b');
title('低通切比雪夫一型双线性相位特性');ylabel('相位 ');xlabel('w/rad');
subplot(2,2,2);plot(w,(angle(hh2)),'b');
title('低通切比雪夫二型双线性相位特性');ylabel('相位 ');xlabel('w/rad');
subplot(2,2,3);plot(w,(angle(hh3)),'b');
title('低通椭圆型双线性相位特性');ylabel('相位 ');xlabel('w/rad');

%%%%%%%%%%%%%%%%%%%%%%%%%%%群延时%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
figure(5);
subplot(2,2,1);plot(wd1,(gd1),'b');
title('低通切比雪夫一型双线性群延时');ylabel('时间 ');xlabel('w/rad');
subplot(2,2,2);plot(wd2,(gd2),'b');
title('低通切比雪夫二型双线性相位特性');ylabel('时间 ');xlabel('w/rad');
subplot(2,2,3);plot(wd3,(gd3),'b');
